...
ball_images = [
    ...
    pygame.image.load(os.path.join(image_path, "baloon 2.png")),
    pygame.image.load(os.path.join(image_path, "baloon 3.png")),
    pygame.image.load(os.path.join(image_path, "baloon 4.png"))]
